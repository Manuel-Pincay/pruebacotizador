...
exports.buildSignedPropertiesTag = void 0;
const constants_1 = require("../../utils/constants");
const buildSignedPropertiesTag = ({ invoiceTagRefId, signedPropertiesTagId, signingTime, x509Hash, x509IssuerName, x509SerialNumber, }) => {
    return `\
...
exports.buildSignedPropertiesTag = buildSignedPropertiesTag;
